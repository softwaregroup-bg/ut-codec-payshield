define([
    ...
    'intern/dojo/node!../test/ndc/data'
    ...
    with (bdd) {
        describe('ndc', function() {
            before(function() {
                console.log('Starting all ndc tests...\n');
            });
            after(function() {
                console.log('Finished testing all ndc tests...\n');
            });
            it('should demonstrate T->C solicitedStatus message', function() {
                processBuffer(samples.solicited, framePattern, function(msg) {
                    ...
                    assert.deepEqual(decodedMsg, {
                        _mtid: 'response', _opcode: 'solicitedStatus', messageClass: '2', messageSubclass: '2', luno: '001000001',
            ...
            it('should demonstrate T->C->T transactionReply message for operationCodeA', function() {
                processBuffer(samples.opCodeA, framePattern, function(msg) {
                    var decodedMsg = ndc.decode(msg);
                    expect(decodedMsg).to.be.a('object');
                    assert.deepEqual(decodedMsg, {
                        _mtid: 'notification', _opcode: 'transaction', messageClass: '1', messageSubclass: '1', luno: '001000001', timeVariant: '08115112',
                    ...
                    var buffer = ndc.encode({
                        _mtid: 'request', _opcode: 'transactionReply', luno: '001', nextState: '007', type1Notes: '00', type2Notes: '00',
            ...
            it('should demonstrate T->C->T transactionReply message for operationCodeB', function() {
                processBuffer(samples.opCodeB, framePattern, function(msg) {
                    var decodedMsg = ndc.decode(msg);
                    expect(decodedMsg).to.be.a('object');
                    assert.deepEqual(decodedMsg, {
                        _mtid: 'notification', _opcode: 'transaction', messageClass: '1', messageSubclass: '1', luno: '001000001',
                    ...
                    var buffer = ndc.encode({
                        _mtid: 'request', _opcode: 'transactionReply', luno: '001', nextState: '133', type1Notes: '00', type2Notes: '00', type3Notes: '00',
            ...
            it('should demonstrate T->C->T transactionReply message for operationCodeD', function() {
                processBuffer(samples.opCodeD, framePattern, function(msg) {
                    ...
                    var buffer = ndc.encode({
                        _mtid: 'request', _opcode: 'transactionReply', luno: '001', nextState: '055', type1Notes: '00', type2Notes: '00',
