...
define([
    'intern!bdd',
    'intern/dojo/node!../payshield.js',
    'intern/dojo/node!assert',
    'intern/dojo/node!ut-validate'
], function(bdd, PayshieldParser, assert, Validator) {
    with (bdd) {
        ...
        encodeTestData = {
            ...
            generateMac: {
                data: { $$: {opcode: 'generateMac', trace: 234 }, macMode: '0', macInputFormat: '2', macAlgorithm: '03', macPaddingMethod: '0', macKeyType: '003', macKey: 'U78C6FD3889386436C41F3874A5DE1F48', msgSize: 8, macMessage: 'testtesttest' },
                buf: new Buffer('000234M602030003U78C6FD3889386436C41F3874A5DE1F480008testtest')
            },

            verifyMac: {
                data: {$$: {opcode: 'verifyMac', trace: 234 }, macMode: '0', macInputFormat: '2', macAlgorithm: '03', macPaddingMethod: '0', macKeyType: '003', macKey: 'U78C6FD3889386436C41F3874A5DE1F48', msgSize: 8
                    , macMessage: 'testtest', mac: '341C677E'},
                buf: new Buffer('000234M802030003U78C6FD3889386436C41F3874A5DE1F480008testtest341C677E')
            },

            formKey: {
                data: { $$: {opcode: 'formKey', trace: 234 }, numberOfComponents: '2', keyType: '003', keyScheme: 'U', keyComponent1: 'U78C6FD3889386436C41F3874A5DE1F48', keyComponent2: 'U78C6FD3889386436C41F3874A5DE1F48'},
            ...
            derivePinIbm: {
                data: {$$: {opcode: 'derivePinIbm', trace: 234 }, pvk: 'X614BCB4CE30FE4FF13C9CFDD180AA182', offset: '0000FFFFFFFF', checkLength: '4', account: '123456789012', decimalisationTable: '1234567812345678',
            ...
            generateOffsetIbm: {
                data: {$$: {opcode: 'generateOffsetIbm', trace: 234 }, keyType: '002', keyA32: 'X614BCB4CE30FE4FF13C9CFDD180AA182', pvk: 'X614BCB4CE30FE4FF13C9CFDD180AA182', pinBlock: '0592789FFFEDCBA9', pinBlockFormat: '01',
                    checkLength: 4, account: '123456789012', decimalisationTable: '1234567812345678', pinValidationData: '23456N543210'},
            ...
            verifyTermPinIbm: {
                data: {$$: {opcode: 'verifyTermPinIbm', trace: 234 }, tpk: 'X725D74BD3FDC0AA910EB213487423466', pvk: 'X614BCB4CE30FE4FF13C9CFDD180AA182', maximumPinLength: 12, pinBlock: '0592789FFFEDCBA9', pinBlockFormat: '01', checkLength: 4
                    , account: '123456789012', decimalisationTable: '1234567812345678', pinValidationData: '23456N543210', offset: 'FFFF34523421'},
            ...
            translateTpkZpk: {
                data: { $$: {opcode: 'translateTpkZpk', trace: 234 }, sourceTpk: 'U8463435FC4B4DAA0C49025272C29B12C', destinationZpk: 'U1EF828AA8F6B80EB83E19FBC373F3A85', sourcePinBlock: '6428EB94035AF53B', sourcePinBlockFormat: '01', destinationPinBlockFormat: '01', account: '550000025321' },
            ...
            translateTpkLmk: {
                data: { $$: {opcode: 'translateTpkLmk', trace: 234 }, sourceTpk: 'U8463435FC4B4DAA0C49025272C29B12C', sourcePinBlock: '6428EB94035AF53B', sourcePinBlockFormat: '01', account: '550000025321'},
                buf: new Buffer('000234JCU8463435FC4B4DAA0C49025272C29B12C6428EB94035AF53B01550000025321')
            },

            translateZpkLmk: {
                data: { $$: {opcode: 'translateZpkLmk', trace: 234 }, sourceZpk: 'U1EF828AA8F6B80EB83E19FBC373F3A85', sourcePinBlock: '91DDDA0A7C12CFAA', sourcePinBlockFormat: '01', account: '550000025321'},
                buf: new Buffer('000234JEU1EF828AA8F6B80EB83E19FBC373F3A8591DDDA0A7C12CFAA01550000025321')
            },

            generateOffsetIbmLmk: {
                data: {$$: {opcode: 'generateOffsetIbmLmk', trace: 234 }, pvk: 'X614BCB4CE30FE4FF13C9CFDD180AA182', pin: '07692', checkLength: 4, account: '123456789012', decimalisationTable: '1234567812345678'
                    , pinValidationData: '23456N543210'},
        ...
        decodeTestData = {
            ...
            generateKeyResp: {
                data: { errorCode: '00', keyA32: 'UD1D3196BE8CE804392F764CDC2ABD75E', keyCheckValue: 'F232C4', $$: {trace: '000234',
