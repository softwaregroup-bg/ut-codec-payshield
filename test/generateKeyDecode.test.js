...
tap.test(`${method}Decode`, (t) => {
    ...
    t.same(payshield.decode(testData[1].request, $meta, context), testResults[1].response, 'generateKey variant decode, under ZMK, success');
    ...
    t.same(payshield.decode(testData[3].request, $meta, context), testResults[3].response, 'generateKey keyblock decode, under ZMK, success');
