module.exports = {
    decodeTests : {
        ...
        'submitSm'  : {
            ...
            'buf'       : new Buffer('', 'hex'),
            'data'      : {
                              'serviceType': 'CMT',
                              'sourceAddrTon': 1,
                              'sourceAddrNpi': 1,
                              ...
                              'protocolId': 0,
                              'priorityFlag': 2,
                              'scheduleDeliveryTime': 'Sat, 24 Jan 2015 13:43:06 GMT',
                              'validityPeriod': 'Sat, 24 Jan 2015 13:43:06 GMT',
        ...
        'deliverSm'  : {
            ...
            'commandId' : '00000005',
            'pattern'   : 'serviceType:6/string-z, sourceAddrTon:8/integer, sourceAddrNpi:8/integer, sourceAddr:21/string-z, destAddrTon:8/integer, destAddrNpi:8/integer, destinationAddr:21/string-z, esmClass:8/integer, protocolId:8/integer, priorityFlag:8/integer, scheduleDeliveryTime:17/string-z, validityPeriod:17/string-z, registeredDelivery:8/integer, replaceIfPresentFlag:8/integer, dataCoding:8/integer, smDefaultMsgId:8/integer, shortMessage:254/string-z, tlvs/binary',
            'buf'       : new Buffer('', 'hex'),
            'data'      : {
                              'serviceType': 'CMT',
                              'sourceAddrTon': 1,
                              'sourceAddrNpi': 1,
        ...
        'replaceSm'  : {
            ...
            'buf'       : new Buffer('000000070000000000000001617364660001013139322e3136382e3132382e313037005361742c203234204a616e20323031352031333a34333a303620474d54005361742c203234204a616e20323031352031333a34333a303620474d5400015073686f7274206d65737361676500', 'hex'),
            'data'      : {
                              'messageId': 'asdf',
                              'sourceAddrTon': 1,
                              'sourceAddrNpi': 1,
