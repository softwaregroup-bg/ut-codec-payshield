define([
    ...
    with (bdd) {
        describe('ndc', function() {
            ...
            it('should demonstrate T->C transactionReply message for operationCodeA', function() {
            ...
            it('should demonstrate T->C transactionReply message for operationCodeB', function() {
            ...
            it('should demonstrate T->C transactionReply message for operationCodeD', function() {
