...
PayshieldParser.prototype.init = function (config) {
    ...
    this.log.info("Initializing Payshield parser! headerFormat: " + config.headerFormat + ", fieldFormat: " + config.fieldFormat + ",messageFormat:" + config.messageFormat);
...
PayshieldParser.prototype.encode = function (data) {
    //TODO: add validation   
    this.log.debug("PayshieldParser.encode data:" + data);
